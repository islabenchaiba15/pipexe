...
const formSchema = z.object({
    ...
    episseur_nom:z.string({
        required_error: 'episseur_nom is required',
    }),
    episseur_min:z.string({
        required_error: 'episseur_min is required',
    }),
...
const PipeForm=()=> {
  ...
  return (
    ...
    <h1 className="text-black text-2xl font-bold">Ajouter manual un pipe</h1>
    <Form {...form1}>
      <form onSubmit={form1.handleSubmit(onSubmit1)} className="flex gap-2 items-center mb-10 mt-5">            
            <FormField
            ...
            render={({ field }) => (
                <FormItem className="flex flex-col items-start">
                    <div className="flex items-center gap-5 w-full">
                        ...
                        <FormControl>
                            <Input placeholder="latitude" {...field} className="w-full" type="number"/>
                         </FormControl>
                    </div>
                    <FormMessage />
                 </FormItem>
            ...
            render={({ field }) => (
                <FormItem className="flex flex-col items-start">
                    <div className="flex items-center gap-5 w-full">
                        ...
                        <FormControl>
                            <Input placeholder="longitude" {...field} className="w-full" type="number"/>
                         </FormControl>
                    </div>
                    <FormMessage />
                 </FormItem>
            ...
            />
            <div className=""> 
                <Button variant="default" className="" type="submit">ajouter</Button>
            </div> 
        </form>
    </Form>
        ...
        <div className="p-2 flex flex-wrap w-fit ">
            {coordinates.length > 0
                ? coordinates.map((coords,index) => (
                    <div key={index} className="flex items-center mr-1 p-2 rounded-2xl bg-gray-200 my-1">
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col items-start w-1/2">
                                <div className="flex items-center gap-5 w-full">
                                    ...
                                    <FormControl>
                                        <Input placeholder="shadcn" {...field} className="w-full" type="number"/>
                                    </FormControl>
                                </div>
                                <FormMessage />
                            </FormItem>
