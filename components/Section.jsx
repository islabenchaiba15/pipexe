  ...
  return (
    <div className='mx-4 p-4'>
        ...
        <div className="flex flex-col items-center  gap-10 my-24">
            ...
            <p className='font-semibold text-white text-xl max-w-3xl text-center'>lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum lorum 
        ...
        <div className="my-20 flex flex-col gap-24">
            <div className="flex flex-col md:flex-row gap-8 md:items-center ">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-10">
                    <h1 className='font-bold text-white md:text-6xl text-3xl'>Optimize routing with customized navigation</h1>
            ...
            <div className="flex flex-col gap-10 md:flex-row-reverse md:gap-8 md:items-center ">
                <div className="w-full md:w-1/2">
                    <Image src={"/aa.png"} alt='' height={400} width={700} className='rounded-2xl'/>
                </div>
                <div className="w-full md:w-1/2 flex flex-col gap-10 ">
                    <h1 className='font-bold text-white md:text-6xl text-3xl'>Bring location to life with beautiful maps</h1>
                    <p className='font-semibold text-gray-500 md:text-3xl text-xl text-left'>
                    Use Mapbox APIs and SDKs, ready-made map styles, 
                    and live updating data to build customizable maps for web,
                     mobile, automotive and AR.
                    </p>
                </div>
            </div>
            <div className="flex flex-col md:flex-row gap-8 md:items-center ">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-10">
                    <h1 className='font-bold text-white md:text-6xl text-3xl'>Transform location features with search  </h1>
                    <p className='font-semibold text-gray-500 md:text-3xl text-xl text-left'>
